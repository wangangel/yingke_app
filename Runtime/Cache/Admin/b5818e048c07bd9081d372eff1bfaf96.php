 ...
 <div class="am-cf admin-main">
  ...
  <div class="admin-content">
        ...
        <div class="am-fl am-cf">
          <div class="am-btn-toolbar am-fl">
            <div class="am-btn-group am-btn-group-xs">
              <a href=<?php echo U("admin/auth/auth_add_show");?>><button type="button" class="am-btn am-btn-default"><span class="am-icon-plus"></span> 新增</button></a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="server_search">
        <form class="am-form-inline" role="form" id="searchForm" action=<?php echo U("admin/auth/auth_search");?> method="post" >
          <div class="am-form-group">
                <input type="text" name="auth_name" placeholder="请输入权限全称！" value="<?php echo ($auth_name); ?>"/>
          </div>
              ...
              <tr>
                ...
                <td>
                  <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                      <a href=<?php echo U('admin/auth/auth_edit_show',array('id'=>$vo['auth_id']));?>><span class="am-icon-pencil-square-o"></span> 编辑  </a>|&nbsp;
                      <a href=<?php echo U('admin/auth/auth_del',array('id'=>$vo['auth_id']));?>><span class="am-icon-trash-o"></span> 删除</a>
                    </div>
                  </div>
                </td>
