      ...
      <div class="am-u-md-6 am-cf">
        <div class="am-fl am-cf">
          <div class="am-btn-toolbar am-fl">
            ...
            <?php if(in_array(($admin_add_show), is_array($hava_authids)?$hava_authids:explode(',',$hava_authids))): ?><a href=<?php echo U("admin/member/admin_add_show");?>><button type="button" class="am-btn am-btn-default"><span class="am-icon-plus"></span> 新增</button></a><?php endif; ?>
            </div>
          </div>
        </div>
      </div>
          ...
          <?php if(is_array($admin_list)): foreach($admin_list as $k=>$vo): ?><tr>
              ...
              <td>
                <div class="am-btn-toolbar">
                  <div class="am-btn-group am-btn-group-xs">
                  <?php if(in_array(($admin_role_show), is_array($hava_authids)?$hava_authids:explode(',',$hava_authids))): ?><a href=<?php echo U('admin/member/admin_role_show',array('id'=>$vo['id']));?>><span class="am-icon-pencil-square-o"></span> 授予角色</a>|&nbsp;<?php endif; ?>
                  <?php if(in_array(($admin_edit_show), is_array($hava_authids)?$hava_authids:explode(',',$hava_authids))): ?><a href=<?php echo U('admin/member/admin_edit_show',array('id'=>$vo['id']));?>><span class="am-icon-pencil-square-o"></span> 编辑  </a>|&nbsp;<?php endif; ?>
                  <?php if(in_array(($admin_del), is_array($hava_authids)?$hava_authids:explode(',',$hava_authids))): ?><a href=<?php echo U('admin/member/admin_del',array('id'=>$vo['id']));?>><span class="am-icon-trash-o"></span> 删除</a><?php endif; ?>
                  </div>
                </div>
              </td>
