      ...
      <div class="am-u-md-6 am-cf">
        <div class="am-fl am-cf">
          <div class="am-btn-toolbar am-fl">
            ...
            <?php if(in_array(($add_show), is_array($hava_authids)?$hava_authids:explode(',',$hava_authids))): ?><a href=<?php echo U("admin/message/add_show");?>><button type="button" class="am-btn am-btn-default"><span class="am-icon-plus"></span> 新增</button></a><?php endif; ?>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="am-u-sm-12">
        <form class="am-form">
          <table class="am-table am-table-striped am-table-hover table-main">
            <thead>
              <tr>
                ...
                <th class="table-title">消息标题</th>
                <th class="table-author">发送者</th>
                <th class="table-author">消息类型</th>
          ...
          <?php if(is_array($message_list)): foreach($message_list as $k=>$vo): ?><tr>
              ...
              <td><?php echo ($vo["sendname"]); ?></td>
              <?php if($vo["messtype"] == '0'): ?><td>系统通知</td>
                <?php else: ?>
                  <td>订单通知</td><?php endif; ?>
              <td><?php echo (date('Y-m-d',$vo["messagetime"])); ?></td>
              <td>
