 ...
 <div class="am-cf admin-main">
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">数据字典列表</strong> / <small>Data List</small></div>
    </div>
        ...
        <div class="am-fl am-cf">
          <div class="am-btn-toolbar am-fl">
            <div class="am-btn-group am-btn-group-xs">
              ...
              <?php if(in_array(($add_show), is_array($hava_authids)?$hava_authids:explode(',',$hava_authids))): ?><a href=<?php echo U("admin/data/add_show");?>><button type="button" class="am-btn am-btn-default"><span class="am-icon-plus"></span> 新增</button></a><?php endif; ?>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="am-g">
      <div class="am-u-sm-12">
        <form class="am-form">
          ...
          <tbody>
          <?php if(is_array($data_list)): foreach($data_list as $k=>$vo): ?><tr>
              <td><?php echo ($k+1); ?></td>
              ...
              <td>
                <div class="am-btn-toolbar">
                  <div class="am-btn-group am-btn-group-xs">
                    <?php if(in_array(($editor_show), is_array($hava_authids)?$hava_authids:explode(',',$hava_authids))): ?><a href=<?php echo U('Admin/data/editor_show',array('id'=>$vo['id']));?>><span class="am-icon-pencil-square-o"></span> 修改  </a>|&nbsp;<?php endif; ?>
                     <?php if(in_array(($data_del), is_array($hava_authids)?$hava_authids:explode(',',$hava_authids))): ?><a href=<?php echo U('Admin/data/data_del',array('id'=>$vo['id']));?>><span class="am-icon-trash-o"></span> 删除</a><?php endif; ?>
                  </div>
                </div>
              </td>
