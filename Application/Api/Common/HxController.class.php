...
class HxController extends Controller{
	...
	private $org_name = 'skyeyeslive';
	private $app_name = 'skyeyeslive';
	private $url  = 'https://a1.easemob.com/skyeyeslive/skyeyeslive/';
	/**
	 * 开放注册模式
	 *
	 ...
	 *        	自定义参数
	 */
	function yy_hxSend($from_user, $username, $content, $target_type = "chatgroups", $ext) {
